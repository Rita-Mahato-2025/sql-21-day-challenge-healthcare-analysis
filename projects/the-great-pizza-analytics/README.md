...
This project analyzes pizza sales data from IDC Pizza to uncover key business insights related to customer orders, pricing strategies, and product performance.

Using SQL, the raw dataset was cleaned, explored, and transformed into meaningful insights that can support decision-making in areas like menu optimization, pricing, and sales strategy.

## Objective

•	Understand sales patterns and customer ordering behavior
•	Identify top-performing pizza categories and sizes
•	Detect data quality issues (missing values, inconsistencies)
